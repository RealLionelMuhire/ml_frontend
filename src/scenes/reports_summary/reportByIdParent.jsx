...
import ReportByIDAccordion from "./ReportByIDAccordion";
import { useLocation } from "react-router-dom";

const ReportByIDParent = () => {
  ...
  return (
    <Box m="20px">
      ...
      {viewMode === "table" ? (
        <ReportByID data={data} selectedReportIds={selectedReportIds} />
      ) : (
        <ReportByIDAccordion data={data} selectedReportIds={selectedReportIds} />
      )}
    </Box>
  );
};

export default ReportByIDParent;
